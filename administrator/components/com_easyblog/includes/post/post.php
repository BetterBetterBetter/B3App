...
class EasyBlogPost extends EasyBlog
{
	...
	public function publish()
	{
		...
		// We need to save the post and revision first in order to link the revision id with the post table.
		$options = array('validateData' => false);
		return $this->save($options);
	}
	 ...
	 * @return
	 */
	public function getIntro($stripTags = false, $truncate = true, $source = 'all')
	{
