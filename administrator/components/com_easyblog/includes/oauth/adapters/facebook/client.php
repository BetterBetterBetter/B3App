...
class EasyBlogClientFacebook extends EasyBlogFacebookConsumer
{
	...
	public function getLoginButton($return, $system = false, $userId = false)
	{
		...
		// Generate the authorize url
		$url = JURI::root() . 'administrator/index.php?option=com_easyblog&task=facebook.authorize';
	...
	{
		$scopes = array('publish_actions', 'manage_pages', 'publish_pages', 'user_groups', 'user_managed_groups');
