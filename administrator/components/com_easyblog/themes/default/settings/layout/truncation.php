    ...
    <div class="col-lg-6">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="page_title" class="col-md-5">
                        <?php echo JText::_('COM_EASYBLOG_SETTINGS_TRUNCATION_COMPOSER_MAX_BLOCKS'); ?>

                        <i data-html="true" data-placement="top" data-title="<?php echo JText::_('COM_EASYBLOG_SETTINGS_TRUNCATION_COMPOSER_MAX_BLOCKS'); ?>" 
                            data-content="<?php echo JText::_('COM_EASYBLOG_SETTINGS_TRUNCATION_COMPOSER_MAX_BLOCKS_DESC');?>" data-eb-provide="popover" class="fa fa-question-circle pull-right"></i>
                    </label>

                    <div class="col-md-7">
                        <div class="row">
                            <div class="col-lg-3">
                                <input type="text" name="composer_truncation_blocks" class="form-control text-center" value="<?php echo $this->config->get('composer_truncation_blocks' , '5');?>" />
                            </div>
                        </div>
                    </div>
                </div>
