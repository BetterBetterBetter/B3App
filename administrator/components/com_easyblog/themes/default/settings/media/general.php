...
<div class="row">
	...
	<div class="col-lg-6">
        <div class="panel">
            <div class="panel-head">
                <b><?php echo JText::_('COM_EASYBLOG_SETTINGS_MEDIA_GALLERY_TITLE');?></b>
            </div>
            ...
            <div class="panel-body">
                <div class="form-group">
                    <label for="page_title" class="col-md-5">
                        ...
                        <i data-html="true" data-placement="top" data-title="<?php echo JText::_('COM_EASYBLOG_SETTINGS_MEDIA_GALLERY_SHOW_ON_FRONTPAGE'); ?>"
                            data-content="<?php echo JText::_('COM_EASYBLOG_SETTINGS_MEDIA_GALLERY_SHOW_ON_FRONTPAGE_DESC');?>" data-eb-provide="popover" class="fa fa-question-circle pull-right"></i>
                    </label>

                    <div class="col-md-7">
                        <?php echo $this->html('grid.boolean', 'main_image_gallery_frontpage', $this->config->get('main_image_gallery_frontpage'));?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="page_title" class="col-md-5">
                        ...
                        <i data-html="true" data-placement="top" data-title="<?php echo JText::_('COM_EASYBLOG_SETTINGS_MEDIA_GALLERY_MAX_WIDTH_PER_ITEM'); ?>"
                            data-content="<?php echo JText::_('COM_EASYBLOG_SETTINGS_MEDIA_GALLERY_MAX_WIDTH_PER_ITEM_DESC');?>" data-eb-provide="popover" class="fa fa-question-circle pull-right"></i>
                    </label>
                    ...
                    <div class="col-md-7">
                        <div class="row">
                            <div class="col-sm-5">
                                <div class="input-group">
                                    <input type="text" name="main_image_gallery_maxwidth" class="form-control text-center" value="<?php echo $this->config->get('main_image_gallery_maxwidth' );?>" />
                ...
                <div class="form-group">
                    <label for="page_title" class="col-md-5">
                        ...
                        <i data-html="true" data-placement="top" data-title="<?php echo JText::_('COM_EASYBLOG_SETTINGS_MEDIA_QUALITY'); ?>"
                            data-content="<?php echo JText::_('COM_EASYBLOG_SETTINGS_MEDIA_RESIZE_ORIGINAL_IMAGE');?>" data-eb-provide="popover" class="fa fa-question-circle pull-right"></i>
                    </label>
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="page_title" class="col-md-5">
                        ...
                        <i data-html="true" data-placement="top" data-title="<?php echo JText::_('COM_EASYBLOG_SETTINGS_MEDIA_MAXIMUM_HEIGHT'); ?>"
                            data-content="<?php echo JText::_('COM_EASYBLOG_SETTINGS_MEDIA_MAXIMUM_HEIGHT');?>" data-eb-provide="popover" class="fa fa-question-circle pull-right"></i>
                    </label>
                ...
                <div class="form-group">
                    <label for="page_title" class="col-md-5">
                        ...
                        <i data-html="true" data-placement="top" data-title="<?php echo JText::_('COM_EASYBLOG_SETTINGS_MEDIA_QUALITY'); ?>"
                            data-content="<?php echo JText::_('COM_EASYBLOG_SETTINGS_MEDIA_QUALITY');?>" data-eb-provide="popover" class="fa fa-question-circle pull-right"></i>
                    </label>
