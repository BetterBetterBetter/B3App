		...
		<table class="app-table app-table-middle table table-striped table-eb" data-table-grid>
			...
			<tbody>
				<?php if( $blogs ){ ?>
					...
					<tr
						data-item
						data-id="<?php echo $row->id . ':' . $row->permalink;?>"
							...
							<div style="white-space: nowrap">
								<?php if ($row->isPublished() && $centralizedConfigured) { ?>
									<?php foreach ($consumers as $consumer) { ?>
										<a class="btn btn-default btn-social btn-<?php echo $consumer->type;?> is-sent btn-sm text-center <?php echo $consumer->isShared($row->id) ? ' is-sent' : '';?>" 
