		...
		<table class="app-table table table-striped table-eb table-hover">
			...
			<tbody>
				<?php if ($posts) { ?>
					...
					<tr>
						<td>
							<?php echo $this->html('grid.id', $i++, $post->id); ?>
						</td>
						<td>
							...
							<div style="margin-top: 10px;">
								...
								&nbsp;
								<a class="btn btn-danger btn-xs" href="javascript:void(0);" data-blog-reject data-id="<?php echo $post->id;?>">
									<i class="fa fa-times-circle"></i>&nbsp; <?php echo JText::_('COM_EASYBLOG_REJECT_BUTTON');?>
								</a>
								&nbsp;
								<a class="btn btn-primary btn-xs" href="javascript:void(0);" data-blog-accept data-id="<?php echo $post->id;?>">
