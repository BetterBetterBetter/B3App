...
},"{tncRead} click":function(){var b="<p>"+Komento.options.config.tnc_text.replace(/\n/g,"<br />")+"</p>";a.dialog({title:a.language("COM_KOMENTO_FORM_TNC"),customClass:"kmt-dialog",width:500,showOverlay:!1,content:b})},"{submitButton} click":function(a){a.checkClick()&&a.html('<img src="'+Komento.options.spinner+'" />'),b.validateComment()},"{unsubscribeButton} click":function(a){a.checkClick()&&(a.html('<img src="'+Komento.options.spinner+'" />'),b.unsubscribe())},"{captchaReload} click":function(){b.reloadCaptcha()
