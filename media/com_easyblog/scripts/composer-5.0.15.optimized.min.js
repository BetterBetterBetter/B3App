...
l.setLayout(b)})}),b.resolve()}),EasyBlog.module("layout/image/legacy",function(a){function c(a){var b=a.parent(),c=b.css("float");if("none"==c&&(c=a.css("float")),"none"==c){var d=a[0].style;"auto"==d.marginLeft&&"auto"==d.marginRight&&(c="center")}return"none"==c&&(c=b.attr("align"),(void 0===c||"none"==c)&&(c=a.attr("align"))),/none|middle/.test(c)&&(c="center"),c}var b=this,d=".easyblog-thumb-preview img, img.easyblog-image-caption, img[data-popup]";a(document).ready(function(){a(d).each(function(){var b=a(this),d=b.parent(),e=b.attr("src"),f=a('<div class="eb-image">'),g=a('<div class="eb-image-figure">');
g.appendTo(f);var h=a('<a class="eb-image-viewport"><img /></a>');h.appendTo(g);d.is("a:not(.easyblog-thumb-preview)");h.attr({href:d.attr("href"),title:d.attr("title"),target:d.attr("target")});var j=f.find("img");j.attr({src:e,width:b.attr("width"),height:b.attr("height"),alt:b.attr("alt")});var k=d.is(".easyblog-thumb-preview"),l=!!b.attr("data-popup"),m=k||l;if(m){var n=a('<a class="eb-image-popup-button" target="_blank"><i class="fa fa-search"></i></a>'),o=k?d.attr("href"):b.attr("data-popup");n.attr({href:o,title:d.attr("title")}).appendTo(h)
}var p=b.is(".easyblog-image-caption");if(p){var q=a('<div class="eb-image-caption"><span></span></div>'),r=b.attr("title");q.appendTo(f).find("span").append(r);var s=b.attr("width");s?q.css("width",s):(q.hide(),j.on("load",function(){q.css("width",j.width()).show()}))}var t=b.attr("data-style")||(p?"gray":"");t&&f.addClass("style-"+t);var u=c(b),v=a('<div class="ebd-block" data-type="image">');/left|right/.test(u)&&v.addClass("is-nested nest-"+u).css("width","auto"),/center/.test(u)&&v.css("text-align","center"),v.append(f),(m?d:b).replaceWith(v)
...
b.setImageLinkTarget(D,d)},"{linkToggle} change":function(a){a.is(":checked")||b.removeImageLink(D)},"{imageViewport} click":function(a,b){b.preventDefault()},setImagePopup:function(c,d,e){var f=B.data(c);b.imagePopupButton.inside(c).remove();var g=b.imageFigure.inside(c),h=a(C.imagePopupButton);g.append(h);var d=f.popup_uri=d||f.popup_uri||f.uri,e=f.popup_variation=e||f.popup_variation,i=E.getMedia(d).done(function(a){var h=(a.meta,E.getVariation(d,[e,"system/large","system/original"]));f.popup_url=h.url,f.popup_variation=h.key,b.imagePopupButton.inside(c).attr("href",f.popup_url)
});return i},unsetImagePopup:function(a){var c=B.data(a);c.popup_url="",c.popup_uri="",c.popup_variation="",b.imagePopupButton.inside(a).remove()},updateImagePopup:function(a,c,d){b.setImagePopup(a,c,d).always(function(){b.populateImagePopup(a)})},removeImagePopup:function(a){b.unsetImagePopup(a),b.populateImagePopup(a)},populateImagePopup:function(c){var d=B.data(c);if(b.popupFieldset().removeClass("hidden"),d.isurl)return b.popupFieldset().addClass("hidden"),void 0;var e=d.popup_uri,f=d.popup_variation,j=d.popup_enabled;
...
}),void 0):!1},updatePreview:function(){var a=f.getBlockContent(h),c=f.data(h);b.previewTitle.inside(a).html(c.title).attr("href",c.url),b.previewContent.inside(a).html(c.content),b.previewLink.inside(a).html(c.url),b.previewImage.inside(a).attr("src",c.image)},getSuggestions:function(a,c,d){EasyBlog.ajax("site/views/crawler/crawl",{url:a}).done(d).fail(function(a){b.showForm(c),b.errorMessage().html(a).removeClass("hide")})},hideForm:function(a){var c=f.getBlockContent(a);b.form.inside(c).addClass("hidden"),b.loader.inside(c).removeClass("hidden")
},showForm:function(a){var c=f.getBlockContent(a);b.form.inside(c).removeClass("hidden"),b.loader.inside(c).addClass("hidden")},"{showImage} change":function(a){var d=f.getBlockContent(h),e=f.data(h),g=a.val();0==g?(e.showImage=!1,b.imageWrapper.inside(d).addClass("hide")):(e.showImage=!0,b.imageWrapper.inside(d).removeClass("hide"))},"{previousImage} click":function(c){var e=b.imageList().children("img"),g=b.imageList().children("img:not(.hidden)"),i=a(g).prev("img"),j=parseInt(b.currentIndex().html()),k=f.data(h);
...
var d=a.data("key"),e=b.getUri(d);"post"==e&&(e=b.getCurrentPostUri(),d=b.getKey(e),a.attr("data-key",d)),EasyBlog.ajax("site/views/mediamanager/tree",{key:d}).done(function(b){a.append(b).data("childTree",b)}).fail(function(){}).always(function(){a.removeClass("is-loading")})}},"{openButton} click":function(a){var c=a.data("key"),d=b.getUri(c);b.navigate(d)},"{folderMoveButton} click":function(a){var c=b.getHint("move"),d=b.folder.of(a),e=d.data("key"),f=b.getUri(e),g=b.getFilename(e);b.openButton.inside(c).attr("data-key",e),b.moveFilename.inside(c).html(g),b.fileMoveButton.inside(c).attr("data-key",e),b.pages().pageslide(c,"next"),b.currentUri=f+"/?move"
},"{folderRenameButton} click":function(c){var d=b.folder.of(c),e=d.data("key"),f=b.getFilename(e);EasyBlog.dialog({content:EasyBlog.ajax("site/views/mediamanager/renameFolderDialog",{current:f}),bindings:{"{submitButton} click":function(){var c=this.folderName().val();""!=a.trim(c)&&(b.renameFolder(e,c),EasyBlog.dialog().close())}}})},"{folderRemoveButton} click":function(a){var c=b.folder.of(a),d=c.data("key"),e=b.getUri(d);EasyBlog.dialog({content:EasyBlog.ajax("site/views/mediamanager/deleteFolderDialog"),bindings:{"{submitButton} click":function(){EasyBlog.ajax("site/views/mediamanager/delete",{key:d}).done(function(){EasyBlog.dialog().close(),b.navigate(b.getParent(e)),b.removeMedia(e)
}).fail(function(){})}}})},"{paginationPrevious} click, {paginationNext} click":function(a){var c=a.data("page"),d=b.getHint("loading");EasyBlog.ajax("site/views/mediamanager/users",{page:c}).done(function(a){d.replaceWith(a)}),b.display(d)},"{file} mouseover":function(a){if("folder"!=a.data("type")){var b=EasyBlog.Composer;b.document.isLegacy()||a.data("uiDraggable")||a.draggable({helper:function(){var b=a.clone();return"image"==a.data("type")?b.addClass("layout-tile").css({width:a.outerWidth(),height:a.outerHeight()}):b.addClass("layout-list"),b
},start:function(b,c){var d=c.helper;if(d.hasClass("layout-list")){var e=b.pageX-a.offset().left,f=c.helper.width(),g=e-f/2;c.helper.css("margin-left",g)}},appendTo:b.ghosts(),connectToSortable:EBD.root})}},"{file} dragstart":function(a){{var d=a.data("key");b.getUri(d)}b.getMedia(d),b.closeMediaManager()},"{closeButton} click":function(){b.closeMediaManager()},"{closeMessageButton} click":function(){b.frame().removeClass("show-foldermove-message show-filemove-message has-messages")}}});a("body").addController(g),b.resolve(g)
})}),EasyBlog.module("mediamanager/uploader",function(a){var b=this;EasyBlog.require().library("plupload2").done(function(){EasyBlog.Controller("MediaManager.Uploader",{elements:["[data-eb-mm-{upload-progress|upload-name|upload-size|upload-progress-value|upload-progress-bar}]","[data-eb-mm-upload-{error-text|error-retry}]"],defaultOptions:{}},function(b,c,d,e){return{init:function(){e=b.mediaManager;var c={runtimes:"html5, html4",autostart:!0},d=e.frame().htmlData("mm-uploader");b.defaultUploadOptions=a.extend(c,d)
...
var c=parseInt(b.tags().attr("data-eb-composer-tags-max"))||null;b.textboxlist().textboxlist({component:"eb",max:c,ignoreLocked:!0,view:{item:"composer/textboxlist/item"},filterItem:function(b){return a.isString(b)?i.sanitize(b):(b.title=i.sanitize(b.title),b)}}),i=b.tagger=a.extend(b.textboxlist().textboxlist("controller"),b.tagger),g.populate("",!0);for(var d=0,e=JSON.parse(b.jsondata().val());existingTag=e[d++];)i.addItem({id:existingTag.id,title:existingTag.title,key:i.getItemKey(existingTag.title)});window.tagz=b
},tagger:{sanitize:function(b){return a.trim(b).replace(/,/g,"")},addLockedItem:function(b){var c=i.get(b),d=c&&!c.locked;c&&i.deleteItem(c.id),i.addItem({id:a.uid("item-"),title:b,key:i.getItemKey(b),locked:!0,assigned:d},!0)}},"{textfield} keydown":function(a,e){var f=e.which,i=h.activeItem;switch(f){case c.UP:case c.DOWN:case c.LEFT:case c.RIGHT:var j=d[f];(i.length>0||"down"==j)&&(g.navigate(j),e.preventDefault());break;case c.ESCAPE:i.length>0?h.deactivate(i):b.suggestions().hasClass("is-showing")?g.collapse():a.val("");
