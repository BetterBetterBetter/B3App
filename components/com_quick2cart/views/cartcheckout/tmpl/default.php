...
{
	techjoomla.jQuery('#' + tab1).toggle('slow');
	techjoomla.jQuery('#' + tab2).toggle('slow');
}
			...
			<div class="sa_steps_parent row-fluid">
				...
				<div class="prev_next_wizard_actions">
					<div class="form-actions">
						<button id="btnWizardPrev" type="button" style="display:none" class="btn pull-left" > <i class="icon-circle-arrow-left icon-white" ></i><?php echo JText::_('COM_QUICK2CART_PREV');?></button>
