	...
	<form action="" name="adminForm" id="adminForm" class="form-validate" method="post">
		...
		<div class="row-fluid" itemscope itemtype="http://schema.org/Product">
			<div class="span12">
									...
									if ($this->itemdetail->featured=='1')
									{
										...
										<div class="pull-left">
											<img title="<?php echo JText::_('QTC_FEATURED_PROD')?>"
												src="<?php echo JUri::base().'components' . DS . 'com_quick2cart' . DS . 'assets' . DS . 'images' . DS . 'featured.png'; ?>"/> &nbsp;
										</div>
										<?php
									}
									?>
										...
										?>
											...
											<div class="" itemprop="brand" itemscope
												...
												<a title="<?php echo JText::_('QTC_CONTACT_STORE_OWN')?>"
													rel="{handler: 'iframe', size: {x: 500, y: 450}, onClose: function(){}}"
													class="btn btn-info btn-mini modal "
						...
						<div class="<?php echo $img_divSize;?>">
							...
							<div class="row-fluid">
								<div class='span12'>
									...
									{
										?>
										<a href="<?php echo $img; ?>" class="swipebox" title="<?php echo $this->itemdetail->name;?>">
									...
									{
										?>
										<img itemprop="image" class='img-rounded qtc_prod_img100by100 q2c_image'
											src="<?php echo $img;?>"
											alt="<?php echo  JText::_('QTC_IMG_NOT_FOUND') ?>" />
										<?php
									}
							...
							if (!empty($images)  && count($images) > 1)
							{
								...
								<div class="row-fluid">
									<div class="span12 qtc_putmargintop qtc_ForLiStyle">
										<ul style="overflow: auto;" class="thumbnails center">
											<?php
						...
						<div class="<?php echo $prod_divSize;?> qtc_prod_blog_page">
							...
							<div class="form-horizontal" id="<?php echo $this->item_id;?>_item" style="width: auto;">
								...
								?>
									...
									<div class="control-group" >
										<label class="control-label" style="<?php echo $showqty_style; ?>">
					...
					if ($this->prodFromCat)
					{
						...
						<div class="row-fluid">
							<div class="span12 well well-small">
								...
								<strong><?php echo JText::sprintf('QTC_SIMILAR_CAT_PRODUCTS', $prodCatName); ?></strong>
								<hr class="hr hr-condensed"/>
								...
								<style type="text/css">
									.q2c_pin_item_<?php echo $random_container;?> {width: 150px !important; margin-bottom: 3px !important;}
								</style>
				...
				<!--row-fluid>span12>span9>span12 end -->
							...
							?>
								<div class="row-fluid" style="<?php echo $WhoBought_style; ?>">
									<div class="span12 well well-small">
										...
										<strong><?php echo JText::_('COM_QUICK2CART_WHO_BOUGHT');?></strong>
										<hr class="hr hr-condensed"/>
						...
						if (! empty($this->peopleAlsoBought))
						{
							...
							<div class="row-fluid">
								<div class="span12 well well-small">
									...
									<strong><?php echo JText::_('QTC_PEOPLE_ALSO_BOUGHT_PRODUCTS');?></strong>
									<hr class="hr hr-condensed"/>
						...
						if (! empty($this->prodFromSameStore))
						{
							...
							<div class="row-fluid">
								<div class="span12 well well-small">
									...
									<strong><?php echo JText::_('QTC_PRODUCTS_FROM_SAME_STORE');?></strong>
									<hr class="hr hr-condensed"/>
