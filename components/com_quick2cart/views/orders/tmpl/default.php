				...
				<?php endif; ?>
					...
					<thead>
						<tr>
							...
							<th class="q2c_width_10 nowrap center">
							...
							{
								?>
								<th class='q2c_width_5 nowrap hidden-phone hidden-tablet  center'>
					...
					<tbody>
						...
						foreach ($result as $orders)
						{
							...
							<tr class="<?php echo $row_color; ?>">
								...
								{
									?>
									<td class="q2c_width_1 nowrap center" data-title="<?php echo JText::_('COM_QUICK2CART_GRID_SELECT');?>">
								...
								<td class="qtc_pending_action q2c_width_30 small center" data-title="<?php echo JText::_('QTC_ORDER_STATUS');?>">
									<?php
									if ((!($orders_site) || !empty($this->storeReleatedView)))
									{
								...
								<td class="q2c_width_10 nowrap small center" data-title="<?php echo JText::_('COM_QUICK2CART_PAYOUT_DATE');?>">
									<?php
								...
								{
									?>
									<td class="q2c_width_5 nowrap hidden-phone hidden-tablet  small center" data-title="<?php echo JText::_('COM_QUICK2CART_ID');?>">
										<?php
											echo $orders->id;
										?>
									</td>
						...
						if ($orders_site)
						{
							...
							<tr>
								...
								<td align="center"><b><?php echo JText::_('QTC_PRODUCT_TOTAL'); ?></b></td>
								<td>
									<span>
