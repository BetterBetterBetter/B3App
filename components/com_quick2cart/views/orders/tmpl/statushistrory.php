				...
				<div class="span12">
					<div class="table-responsive">
						<table class="" id="complete-order" name="complete-order">
							<thead>
							<tr>
								<th class="q2c_width_40"></th>
								<th class="q2c_width_60"></th>
							</tr>
							</thead>
							<tr>
							...
							<tr>
								...
								<td><textarea id="" name="order_note" rows="3" size="28" value=""></textarea></td>
							</tr>
							<tr>
								<td></td>
								<td>
...
-->
									...
									<button  class="btn  btn-success " title="<?php echo JText::_('COM_QUICK2CART_UPDAE_ORDER_STATUS');?>" ><?php echo JText::_('COM_QUICK2CART_UPDAE_ORDER_STATUS'); ?></button>
								</td>
							</tr>
					</table>
					<hr/>
