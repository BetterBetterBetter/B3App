		...
		<div id='qtcOptionsWraper' style="<?php echo $showQtcFields; ?>">
			<div id='' class=" <?php echo $class_nm;?>" >
				...
				if ($isTaxationEnabled  || $qtc_shipping_opt_status)
				{
					...
					$qtcshiphelper = $comquick2cartHelper->loadqtcClass(JPATH_SITE.DS."components".DS."com_quick2cart".DS."helpers".DS."qtcshiphelper.php","qtcshiphelper");
			...
			{ ?>
			  <div >
				...
				// CHECK for view override
					...
					$att_list_path=$comquick2cartHelper->getViewpath('attributes','attribute_list',"ADMIN","SITE");
					$html_attri = '';
					ob_start();
