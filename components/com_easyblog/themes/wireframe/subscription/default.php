...
<div class="eb-subscription">
    ...
    <?php foreach ($groups as $group) { ?>
        ...
        <div class="eb-subscribe row-table cell-top">
            <div class="col-cell eb-subscribe-thumb cell-tight">
                <a href="#" class="eb-avatar" class="eb-avatar">
                    <img src="<?php echo $subscription->object->getAvatar();?>" />
                </a>
            </div>
            <div class="col-cell cell-ellipse eb-subscribe-details">
                ...
                <a href="javascript:void(0);" data-blog-unsubscribe data-subscription-id="<?php echo $subscription->id;?>" data-return="<?php echo base64_encode(JRequest::getUri());?>">
                    <?php echo JText::_('COM_EASYBLOG_UNSUBSCRIBE');?>
                </a>
            </div>
        </div>
