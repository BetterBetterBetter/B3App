	...
	<div class="eb-box eb-table">
		<div class="eb-table-head row-table align-midle">
			<div class="col-cell cell-check">
				<input class="check-clear" type="checkbox" data-eb-form-checkall />
			</div>
		...
		<div class="eb-table-body">
			...
			<div class="row-table layout-fixed align-top" data-eb-moderate-item data-id="<?php echo $post->revision_id;?>">
				<div class="col-cell cell-check">
					<input type="checkbox" class="check-clear" name="ids[]" value="<?php echo $post->revision_id;?>" data-eb-form-checkbox />
				...
				<div class="col-cell cell-clear-right">
					<div class="eb-table-revision mb-5">
						<a href="<?php echo $post->getEditLink(); ?>" style="text-transform: uppercase; font-size: 11px; color: #999;"><?php echo JText::sprintf('COM_EASYBLOG_DASHBOARD_REVISION_NUMBER', $post->revisionOrdering);?></a>
					</div>
