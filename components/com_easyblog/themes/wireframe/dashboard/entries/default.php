	...
	<div class="eb-box eb-table">
		<div class="eb-table-head row-table align-middle">
			<div class="col-cell cell-check">
				<input type="checkbox" class="check-clear" data-eb-form-checkall />
			</div>
		...
		<div class="eb-table-body">
			...
			<div class="row-table align-top" data-eb-post-item data-id="<?php echo $post->id;?>">
				<div class="col-cell cell-check">
					<input class="check-clear" type="checkbox" name="ids[]" value="<?php echo $post->id;?>" data-eb-form-checkbox />
				...
				<div class="col-cell cell-option">
					<div class="dropdown_">
						...
						<ul class="dropdown-menu">
							...
							<?php if ((!$post->locked && $this->acl->get('add_entry') ) || EB::isSiteAdmin()) { ?>
								<li>
